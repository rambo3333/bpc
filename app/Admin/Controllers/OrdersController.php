...
class OrdersController extends Controller
{
    ...
    public function confirm(Order $order, Request $request)
    {
        ...
        \DB::transaction(function() use ($order, $data) {
             ...
             * 对当前业务员的影响：
             * 查看业务员是否有效，如果无效，改成有效
             * 如果当前级别星星全部点亮，且销售数量达到下一级别，则升级
             *
             * 对上级的影响（如果存在上级的话）：
             * 业务员从无效变成有效的影响： 1.判断该业务员是否晋级,发现是没有晋级
             *                           如果存在上级，正好是第五个生效的，该上级就变成支队长。
             *                           如果该上级存在上级，正好是第五个生效的支队长，则上上级成为大队长。
             *                           如果该上上级存在上级，正好是第五个生效的大队长，则上上上级成为总队长
             *
             *                         2.判断该业务员是否晋级，发现是支队长
             *                           如果存在上级，正好是第五个生效的支队长，则上级成为大队长
             *                           如果上级存在上级，正好是第五个生效的大队长，则上上级成为总队长
             *
             *                         3.判断该业务员是否晋级，发现是大队长
             *                           如果存在上级，正好是第五个生效的大队长，则上级成为总队长
             */
